...
class LicenseInvoiceGenerator:
    ...
    def _generate_qr_b64(self, data):
        ...
        try:
            license_key = data.get('license_key', 'N/A')[:50]
    ...
    def generate_pdf(self, data, filename):
        ...
        <body>
            ...
            <div class="header">
                <div class="company-name">World Lock / Studio Tai</div>
                <div class="company-info">Mobile Service & Photography</div>
                <div class="company-info">📱 +959259282400 | +95968098642</div>
                <div class="company-info">💬 WhatsApp/Telegram: +959259282400</div>
            </div>
            ...
            <table style="width: 100%; margin-bottom: 20px;">
                <tr>
                    ...
                    <td style="width: 50%; vertical-align: top; padding-left: 10px;">
                        ...
                        <div class="row"><div class="label">Name:</div><div class="value">{data.get('customer_name', 'N/A')}</div></div>
            ...
            <table class="full-width-table">
                ...
                <tr>
                    <th>Expiry Date</th>
                    <td>{data.get('expiry_date', 'N/A')}</td>
                </tr>
                <tr>
            ...
            <div class="section-title" style="margin-top: 20px;">License Key</div>
            <div class="license-key-box">
                {data.get('license_key', 'N/A')}
            </div>
            
            <div style="font-size: 8pt; margin-top: 10px;">
                <b>Notes:</b> {data.get('notes', '')}
            </div>
            
            <div class="qr-container">
                <img src="data:image/png;base64,{self._generate_qr_b64(data)}" width="100" height="100">
            </div>
