...
- ✨ Improved textarea styling with premium dark theme
- 🔄 Cache busting for instant UI updates
- 🔢 Numeric input restrictions for phone, IMEI, and amounts
- 📱 Better mobile responsiveness

### Commission System

- 💵 Service-charge only commission calculation
- 📊 Accurate performance tracking
- 🎯 Fixed calculation logic for technician earnings

### Technician Tools

- 🔐 Visual device lock display (pattern grid)
- 🗑️ Removed redundant labor timer
...
2. Note the IP address shown in the Mobile Pairing dialog
3. On your mobile device, navigate to `http://<IP>:8000`
